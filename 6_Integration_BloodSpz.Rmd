...
PvBS<-readRDS("outputs/6b_PvBSInt_NoT_CCA.rds")
...
ggsave("plots/Blood-stage_reps.svg", width = 7, height = 7, units = "in", dpi = 320)
...
ggsave("plots/Fig6a_D.svg", width = 20, height = 18, units = "in", dpi = 320)
